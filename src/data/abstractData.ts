...
export const submissionGuidelines = {
  ...
  importantDatesReservationNoteTh: "ทั้งนี้ การพิจารณาจะสงวนสิทธิให้เฉพาะผู้ที่ส่ง Abstract รอบที่ 1 และได้รับการ Approved Abstracts แล้วเท่านั้น",
  presenterRegistrationNote: "If you submit your abstract during the Early Bird period (1 May - 30 June 2026) and your abstract is approved, you will still be eligible for the Early Bird registration rate of THB 1,000 even if approval is granted after the Early Bird period has ended.",
  presenterRegistrationNoteTh: "หากท่านส่ง Abstract ภายในช่วงระยะเวลา Early Bird คือ 1 พฤษภาคม - 30 มิถุนายน 2569 และ Abstract ของท่านต้องได้รับการอนุมัติเท่านั้น ท่านถึงจะได้รับสิทธิราคาตั๋วเข้างานเป็นราคา Early Bird 1,000 บาท แม้จะพ้นช่วงระยะเวลา Early Bird ไปแล้ว",
  presenterRegistrationNoteSegments: [
    { text: "If you " },
    { text: "submit your abstract during the Early Bird period", accent: true },
    { text: " (1 May - 30 June 2026) and your abstract " },
    { text: "must be approved only", accent: true },
    { text: ", you will still be eligible for the Early Bird registration rate of THB 1,000 even if approval is granted after the Early Bird period has ended." },
  ],
  presenterRegistrationNoteSegmentsTh: [
    { text: "หากท่าน" },
    { text: "ส่ง Abstract ภายในช่วงระยะเวลา Early Bird", accent: true },
    { text: " คือ 1 พฤษภาคม - 30 มิถุนายน 2569 และ Abstract ของท่าน" },
    { text: "ต้องได้รับการอนุมัติเท่านั้น", accent: true },
    { text: " ท่านถึงจะได้รับสิทธิราคาตั๋วเข้างานเป็นราคา Early Bird 1,000 บาท แม้จะพ้นช่วงระยะเวลา Early Bird ไปแล้ว" },
  ],
  ...
  policies: {
    ...
    acceptance: [
      ...
      "On receiving the acceptance notification, the abstract submitter must confirm attendance of the presenting author and instruct the presenting author to register no later than 10th June 2026 and pay the registration fee in full by 30th June 2026.",
    ...
    acceptanceTh: [
      ...
      "เมื่อได้รับแจ้งสถานะการรับผลงาน ผู้ส่งรายการต้องยืนยันการเข้าร่วมของผู้เสนอผลงานและแจ้งให้ผู้นำเสนอลงทะเบียนภายในวันที่ 10 มิถุนายน 2569 และชำระค่าลงทะเบียนเต็มจำนวนภายในวันที่ 30 มิถุนายน 2569",
      "บทคัดย่อที่ได้รับสถานะการรับจะถูกยกเลิกโดยอัตโนมัติหากผู้นำเสนอไม่ได้ลงทะเบียนและชำระค่าลงทะเบียนตามวันกำหนด",
    ],
    withdrawal: "Authors who want to withdraw an abstract should send a written request to the secretariat at pris2026@pharmacy.org by 10th June 2026.",
    withdrawalTh: "ผู้ประพันธ์ที่ต้องการยกเลิกบทคัดย่อควรส่งข้อความการขอร้องเขียนให้สำนักงานกลางที่ pris2026@pharmacy.org ก่อนวันที่ 10 มิถุนายน 2569",
  },
};
