export const abstractTimeline = [
  ...
  {
    label: "Abstract Submission Result Announcement",
    labelTh: "ประกาศผล Abstract",
...
export const submissionGuidelines = {
  ...
  importantDatesReservationNote: "This consideration is reserved only for participants who submit an abstract and receive an approved abstract.",
  importantDatesReservationNoteTh: "หมายเหตุ: สิทธินี้จะมอบให้เฉพาะผู้ที่ส่งผลงานและได้รับการยืนยันผลการพิจารณา (Approved Abstracts) เป็นที่เรียบร้อยแล้วเท่านั้น",
  presenterRegistrationNote: "Authors whose abstracts are approved will receive the Early Bird registration rate (THB 1,250) even if the approval is granted after the Early Bird period ends.",
  presenterRegistrationNoteTh: "ผู้ส่งบทคัดย่อและได้รับการอนุมัติ จะได้รับสิทธิ์ลงทะเบียนในราคา Early Bird (1,250 บาท) แม้ว่าจะพ้นช่วงเวลาดังกล่าวไปแล้ว",
  presenterRegistrationNoteSegments: [
    { text: "If you " },
    { text: "submit your abstract", accent: true },
    { text: " (1 July - 31 August 2026) and your abstract " },
  ...
  presenterRegistrationNoteSegmentsTh: [
    ...
    { text: "วันที่ 1 กรกฎาคม – 31 สิงหาคม 2569", accent: true },
  ...
  policies: {
    ...
    withdrawalTh: "ผู้ประพันธ์ที่ต้องการยกเลิกบทคัดย่อควรส่งข้อความการขอร้องเขียนให้สำนักงานกลางที่ pr@pharmacycouncil.org ก่อนวันที่ 30 มิถุนายน 2569",
  },
};
