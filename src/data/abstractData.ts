export const abstractTimeline = [
  {
    ...
    labelTh: "\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d \u0e23\u0e2d\u0e1a 1",
    date: "Opening date to be announced; closes 20 June 2026",
    dateTh: "\u0e27\u0e31\u0e19\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e08\u0e30\u0e41\u0e08\u0e49\u0e07\u0e20\u0e32\u0e22\u0e2b\u0e25\u0e31\u0e07; \u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a 20 \u0e21\u0e34\u0e16\u0e38\u0e19\u0e32\u0e22\u0e19 2569",
    status: "upcoming",
    color: "blue",
  },
  {
    label: "Abstract Submission Round 2",
    labelTh: "\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d \u0e23\u0e2d\u0e1a 2",
    date: "1 July - 20 August 2026",
    dateTh: "1 \u0e01\u0e23\u0e01\u0e0e\u0e32\u0e04\u0e21 - 20 \u0e2a\u0e34\u0e07\u0e2b\u0e32\u0e04\u0e21 2569",
    status: "upcoming",
    color: "blue",
  },
  {
    label: "Review Period",
    labelTh: "\u0e23\u0e30\u0e22\u0e30\u0e40\u0e27\u0e25\u0e32\u0e1e\u0e34\u0e08\u0e32\u0e23\u0e13\u0e32",
    date: "About 1 week after submission",
    dateTh: "\u0e1b\u0e23\u0e30\u0e21\u0e32\u0e13 1 \u0e2a\u0e31\u0e1b\u0e14\u0e32\u0e2b\u0e4c\u0e2b\u0e25\u0e31\u0e07\u0e44\u0e14\u0e49\u0e23\u0e31\u0e1a\u0e1c\u0e25\u0e07\u0e32\u0e19",
    status: "upcoming",
    color: "blue",
  },
  {
    label: "Late Abstract (Round 3)",
    labelTh: "\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d\u0e23\u0e2d\u0e1a\u0e17\u0e49\u0e32\u0e22 (\u0e23\u0e2d\u0e1a 3)",
    date: "September 2026 subject to availability",
    dateTh: "\u0e20\u0e32\u0e22\u0e43\u0e19\u0e40\u0e14\u0e37\u0e2d\u0e19\u0e01\u0e31\u0e19\u0e22\u0e32\u0e22\u0e19 \u0e15\u0e32\u0e21\u0e04\u0e27\u0e32\u0e21\u0e40\u0e2b\u0e21\u0e32\u0e30\u0e2a\u0e21",
    status: "upcoming",
    color: "blue",
  },
];
  ...
  importantDates: [
    {
      label: "Abstract submission round 1",
      labelTh: "\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d \u0e23\u0e2d\u0e1a 1",
      value: "Opening date to be announced; closes 20 June 2026",
      valueTh: "\u0e27\u0e31\u0e19\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e08\u0e30\u0e41\u0e08\u0e49\u0e07\u0e20\u0e32\u0e22\u0e2b\u0e25\u0e31\u0e07; \u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a 20 \u0e21\u0e34\u0e16\u0e38\u0e19\u0e32\u0e22\u0e19 2569",
      highlight: true,
    },
    {
      label: "Abstract submission round 2",
      labelTh: "\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d \u0e23\u0e2d\u0e1a 2",
      value: "1 July - 20 August 2026",
      valueTh: "1 \u0e01\u0e23\u0e01\u0e0e\u0e32\u0e04\u0e21 - 20 \u0e2a\u0e34\u0e07\u0e2b\u0e32\u0e04\u0e21 2569",
    },
    {
      label: "Review period",
      labelTh: "\u0e23\u0e30\u0e22\u0e30\u0e40\u0e27\u0e25\u0e32\u0e1e\u0e34\u0e08\u0e32\u0e23\u0e13\u0e32",
      value: "About 1 week after submission",
      valueTh: "\u0e1b\u0e23\u0e30\u0e21\u0e32\u0e13 1 \u0e2a\u0e31\u0e1b\u0e14\u0e32\u0e2b\u0e4c\u0e2b\u0e25\u0e31\u0e07\u0e44\u0e14\u0e49\u0e23\u0e31\u0e1a\u0e1c\u0e25\u0e07\u0e32\u0e19",
    },
    {
      label: "Late Abstract (Round 3)",
      labelTh: "\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d\u0e23\u0e2d\u0e1a\u0e17\u0e49\u0e32\u0e22 (\u0e23\u0e2d\u0e1a 3)",
      value: "September 2026 subject to availability",
      valueTh: "\u0e20\u0e32\u0e22\u0e43\u0e19\u0e40\u0e14\u0e37\u0e2d\u0e19\u0e01\u0e31\u0e19\u0e22\u0e32\u0e22\u0e19 \u0e15\u0e32\u0e21\u0e04\u0e27\u0e32\u0e21\u0e40\u0e2b\u0e21\u0e32\u0e30\u0e2a\u0e21",
    },
  ],
  presenterRegistrationNote: "Round 1 opening date will be announced later. Review takes about 1 week after submission and a late abstract round in September may be announced if appropriate.",
  presenterRegistrationNoteTh: "\u0e27\u0e31\u0e19\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d\u0e23\u0e2d\u0e1a 1 \u0e08\u0e30\u0e41\u0e08\u0e49\u0e07\u0e43\u0e2b\u0e49\u0e17\u0e23\u0e32\u0e1a\u0e20\u0e32\u0e22\u0e2b\u0e25\u0e31\u0e07 \u0e43\u0e0a\u0e49\u0e40\u0e27\u0e25\u0e32\u0e1e\u0e34\u0e08\u0e32\u0e23\u0e13\u0e32\u0e1b\u0e23\u0e30\u0e21\u0e32\u0e13 1 \u0e2a\u0e31\u0e1b\u0e14\u0e32\u0e2b\u0e4c\u0e2b\u0e25\u0e31\u0e07\u0e44\u0e14\u0e49\u0e23\u0e31\u0e1a\u0e1c\u0e25\u0e07\u0e32\u0e19 \u0e41\u0e25\u0e30\u0e2d\u0e32\u0e08\u0e21\u0e35\u0e01\u0e32\u0e23\u0e40\u0e1b\u0e34\u0e14\u0e23\u0e31\u0e1a\u0e1a\u0e17\u0e04\u0e31\u0e14\u0e22\u0e48\u0e2d\u0e23\u0e2d\u0e1a\u0e17\u0e49\u0e32\u0e22\u0e43\u0e19\u0e40\u0e14\u0e37\u0e2d\u0e19\u0e01\u0e31\u0e19\u0e22\u0e32\u0e22\u0e19\u0e15\u0e32\u0e21\u0e04\u0e27\u0e32\u0e21\u0e40\u0e2b\u0e21\u0e32\u0e30\u0e2a\u0e21",
