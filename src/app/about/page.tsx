    ...
    >
      ...
      <section className="relative pt-40 md:pt-56 pb-20 md:pb-32 px-6 md:px-12 flex flex-col justify-end items-center text-center">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 text-center flex flex-col items-center">
          <div className="about-hero-sub flex items-center gap-4 mb-8">
            ...
            <span className="text-gray-300 text-[10px] tracking-widest uppercase">— Bangkok, Thailand</span>
          </div>
      ...
      <section className="relative px-6 md:px-12 pb-28 md:pb-40">
        <div className="max-w-4xl mx-auto about-desc">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 tracking-tight text-gray-900">What is PRIS?</h2>
          <p className="text-gray-500 text-base md:text-lg leading-[1.8] font-light">
            PRIS, or the <span className="text-orange-600 font-medium">Pharmacy Research and Innovation Summit</span>, is
            a national pharmacy and innovation academic conference organized to unite pharmacists from
            all fields — academia, hospitals, community pharmacy, marketing, and the industrial sector.
            It focuses on the exchange of knowledge in research and pharmaceutical innovation, with the
            goal of <span className="text-orange-600 font-medium">driving the pharmacy profession forward</span> to keep
            pace with the changes in the modern healthcare world.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="committee-block mb-20 md:mb-28">
            <div className="flex items-center gap-4 mb-6">
              <span className="w-12 h-px bg-blue-600" />
              <span className="text-[10px] font-semibold tracking-[0.3em] uppercase text-blue-600">Organizing Team</span>
            </div>
          ...
          <div className="committee-block mb-20">
            <h3 className="text-xs font-semibold tracking-[0.25em] uppercase text-gray-400 mb-6">Advisors</h3>
