      ...
      <div ref={containerRef} className="w-full max-w-xl px-4 z-10 relative">
        <div className="bg-white rounded-[1.5rem] p-8 md:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-100 fade-in-up">
          ...
          <div className="mb-6 fade-in-up">
            <Link 
              href="/signup" 
              className="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-orange-600 transition-colors group"
            >
              <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-50 group-hover:bg-orange-50 transition-colors">
          ...
          <div className="text-center mb-8 fade-in-up">
            ...
            <p className="text-sm font-medium text-gray-500">
              Please fill in your details to register as a Pharmacist
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 fade-in-up">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium"
                  required
                />
              </div>
              <div>
            ...
            <div className="fade-in-up">
              <label className="block text-[13px] font-bold text-gray-700 mb-2" htmlFor="licenseNumber">
            ...
            <div className="fade-in-up">
              ...
              <div className="flex">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-r-xl border border-gray-300 bg-white text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-medium"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 fade-in-up">
              <div>
                ...
                <input
                  ...
                  id="password"
                  placeholder="••••••••"
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white text-gray-900 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all tracking-widest"
                  required
                />
              </div>
              <div>
