...
import { QrCode, LogOut, Mail, Briefcase, BadgeCheck, FileText, User } from "lucide-react";
...
export default function ProfilePage() {
  ...
  return (
    <main
      ref={containerRef}
      className="min-h-screen flex flex-col items-center bg-[#f4f6f8] text-slate-900 pt-24 pb-20 px-6 sm:px-10 selection:bg-blue-600 selection:text-white relative overflow-hidden"
    >
