...
export default function AbstractSubmission() {
  ...
  const steps = [
    { id: 1, label: "Presenting Author", icon: <User className="w-5 h-5" /> },
    { id: 2, label: "Co-Authors", icon: <Users className="w-5 h-5" /> },
    { id: 3, label: "Abstract Details", icon: <FileText className="w-5 h-5" /> },
    { id: 4, label: "Body & File", icon: <Upload className="w-5 h-5" /> },
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500 font-medium text-lg leading-relaxed pt-4">
                    Document your scientific breakthroughs and contribute to the evolution of pharmaceutical science.
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              {abstractCategories.map(cat => <option key={cat.id} value={cat.title}>{cat.title}</option>)}
            </select>
          </div>
